...
- 좋았던 점 :
  새로운 도전의 경험이 쌓여 새로운 도전을 할 수 있는 ‘힘’을 길렀다.
  webRTC, webSocket등을 사용하며 실시간 기술에 대한 지식을 얻을 수 있었다.
  상태관리 라이브러리를 통해 데이터를 효과적으로 관리할 수 있었다.
  서비스가 어떻게 만들어지는지 흐름을 경험할 수 있었다.
  아쉬운 점 :
  처음 도전하고 싶었던 typescript는 사용하지 못했다.
