...
![로그인](../../../docs/assets/web-demo/voice/community-voice-chatting.gif)
...
| ![로그인](../../../docs/assets/web-demo/sign/login.gif) | ![회원가입](../../../docs/assets/web-demo/sign/register.gif) |
| ------------------------------------------------------- | ------------------------------------------------------------ |
| 로그인                                                  | 회원가입                                                     |
...
| ![친구추가](../../../docs/assets/web-demo/friend/add-friend.gif) | ![친구수락](../../../docs/assets/web-demo/friend/accept-friend.gif) | ![친구차단](../../../docs/assets/web-demo/friend/block-friend.gif) |
| ---------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 친구추가                                                         | 친구수락                                                            | 친구차단                                                           |
...
| ![친구에게 메시지 걸기](../../../docs/assets/web-demo/friend/send-message-to-friend.gif) | ![친구에게 전화걸기](../../../docs/assets/web-demo/friend/call-to-friend.gif) |
| ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
...
| ![1:1DM](../../../docs/assets/web-demo/dm/one-to-one-direct-message.gif) | ![그룹DM](../../../docs/assets/web-demo/dm/group-direct-message.gif) | ![DM 통화 및 채팅](../../../docs/assets/web-demo/voice/dm-voice-chatting.gif) |
| ------------------------------------------------------------------------ | -------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 1:1DM                                                                    | 그룹DM                                                               | DM 통화 및 채팅                                                               |

### 메시지 알림

| ![DM UI 알림](../../../docs/assets/web-demo/fcm/dm-alarm-ui.gif) | ![DM FCM알림](../../../docs/assets/web-demo/fcm/fcm_alaram.gif) |
| ---------------------------------------------------------------- | --------------------------------------------------------------- |
| DM UI                                                            | DM FCM                                                          |

### 커뮤니티 초대

| ![초대하기](../../../docs/assets/web-demo/community/invite-friend.gif) | ![초대받기](../../../docs/assets/web-demo/community/get-invited-to-community.gif) |
| ---------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| 초대하기                                                               | 초대받고 커뮤니티 입장하기                                                        |

### 커뮤니티

| ![초대하기](../../../docs/assets/web-demo/community/create-community-category-channel-and-drag-and-drop.gif) | ![초대받기](../../../docs/assets/web-demo/community/edit-and-delete-community.gif) | ![커뮤니티자유로운채팅](../../../docs/assets/web-demo/community/community-chatting-channel.gif) |
| ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| 커뮤니티,카테고리, 채널 생성하기, drag and drop                                                              | 커뮤니티,카테고리, 채널 편집, 수정하기                                             | 커뮤니티 자유로운 채팅                                                                          |

### 실시간 상태 관리

| ![타이핑상태](../../../docs/assets/web-demo/state/state-typing.gif) | ![내친구의 활동상태](../../../docs/assets/web-demo/state/state-lobby.gif) | ![음성채널 참가 멤버](../../../docs/assets/web-demo/state/voice-channel-state.gif) |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| 타이핑 상태                                                         | 내친구의 활동상태                                                         | 음성채널 참가 멤버                                                                 |

| ![smooth 접속 ](../../../docs/assets/web-demo/state/access-and-exit-page.gif) | ![dm방에서 멤버 접속 확인](../../../docs/assets/web-demo/state/dm-state-onoff.gif) | ![커뮤니티 채팅방 멤버 접속 확인](../../../docs/assets/web-demo/state/community-state-onoff.gif) |
| ----------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
